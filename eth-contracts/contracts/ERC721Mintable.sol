...
contract Pausable is Ownable{
    ...
    function changePause(bool pause) onlyOwner public{
        require(pause != _paused, "Contractalready in that state");
        _paused = pause;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "Token already owned by address");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((msg.sender == _tokenOwner[tokenId]) || (isApprovedForAll(_tokenOwner[tokenId],msg.sender)), "Account is not token owneror approver");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "Address is not the owner");
        // TODO: require token is being transfered to valid address
        require(!to.isContract(),"Token not being transfered to correct address");
        // TODO: clear approval
...
contract CustomERC721Token is ERC721Metadata{
    ...
    function mint(address to, uint tokenId) onlyOwner public returns (bool){
        ...
        ERC721Metadata._setTokenURI(tokenId);
        return true;
    }
}
